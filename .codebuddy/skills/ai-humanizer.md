...
name: ai-humanizer
description: |
  AI 文本检测与人性化工具 - 检测并修复 AI 生成文本的痕迹，使文字听起来更自然、更有人味。
  基于 24 种 AI 写作模式进行检测，提供人性化重写和质量评分。
allowed-tools:
  - Read
  - Write
  - Edit
...
1. **检测 AI 模式** - 扫描文本中的 24 种 AI 写作模式
2. **人性化重写** - 去除 AI 痕迹，注入真实个性
3. **质量评分** - 评估文本人性化程度
4. **提供建议** - 给出具体的改进建议
